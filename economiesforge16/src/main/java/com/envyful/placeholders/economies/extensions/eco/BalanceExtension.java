...
public class BalanceExtension extends AbstractEconomiesExtension implements PlaceholderExtension<ServerPlayerEntity> {
    ...
    private static final List<String> DESCRIPTION = Lists.newArrayList("Gets the balance for the given player in the given economy");
    private static final List<String> EXAMPLES = Lists.newArrayList("%economiesforge_balance_coins_Envyful%");
    ...
    protected String parse(ServerPlayerEntity player, String placeholder, Economy economy) {
        ...
        return String.format(economy.getFormat(), attribute.getAccount(economy).getBalance());
    }
}
