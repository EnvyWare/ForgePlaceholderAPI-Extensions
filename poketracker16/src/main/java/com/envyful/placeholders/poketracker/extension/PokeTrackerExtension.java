...
public abstract class PokeTrackerExtension extends AbstractExtension<ServerPlayerEntity> {
    ...
    public abstract String parse(ServerPlayerEntity player, String placeholder, EntityData entityData);
}
