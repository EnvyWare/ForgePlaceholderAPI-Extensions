...
public class DexPercentageExtension extends SimpleExtension<ServerPlayerEntity> {
    ...
    private static final List<String> EXAMPLES = Lists.newArrayList("%reforged_dex_percent%");
