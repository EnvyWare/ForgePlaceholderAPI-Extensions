...
public abstract class PartyReforgedExtension extends AbstractExtension<ServerPlayerEntity> {
    ...
    protected abstract String parse(ServerPlayerEntity player, String placeholder, Pokemon pokemon);
}
